...
OPEN_AI__META_DATA_GENERATION_MODEL = 'gpt-3.5-turbo-0125' # models - https://platform.openai.com/docs/models
...
NEWS_RETREIVAL_HUMAN_PROMPT = "The Path and Code from the file. Path: {path}. Code: {code}"
